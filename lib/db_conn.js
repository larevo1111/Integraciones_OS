...
const TIMEZONE = process.env.DB_TIMEZONE || '-05:00'
...
module.exports = {
  TIMEZONE,
  // Pool a BD local (effi_data, ia_service_os, os_whatsapp, os_inventario, ia_local, espocrm, nextcloud, …)
  local(dbName) { return poolLocal(dbName) },
  // Pools remotos (abre tunnel SSH la primera vez)
