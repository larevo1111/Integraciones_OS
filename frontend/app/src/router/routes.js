...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'ventas/facturas-producto/:cod_articulo',           component: () => import('pages/ventas/DetalleFacturasProductoPage.vue') },
      { path: 'ventas/facturas-grupo/:grupo',                     component: () => import('pages/ventas/DetalleFacturasProductoPage.vue') },
